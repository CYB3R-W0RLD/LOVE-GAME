...
startButton.addEventListener("click", () => {
    ...
    if (input== ""){
        ...
        "<title>Do You Love CHANDRAKANT?</title>"+
...
function yesButtonListener(){
    document.body.innerHTML = "<div class='wrapper'><h2 class='question'>Yay! Thank you for loving CHANDRAKANT ❤️, "+input+ "!</h2>"+
...
function noButtonListener(){
    if (count < 5) {
        ...
        questionMain.innerHTML = "You don't love CHANDRAKANT?";
    }
    else if (count >= 5 && count < 10){
        gifMain.src ="https://media.giphy.com/media/QuCslOrnS649PSCnn7/giphy.gif";
        questionMain.innerHTML = "Stop playing with CHANDRAKANT! Do you love CHANDRAKANT or not?!";
    }
    else{
        gifMain.src ="https://media.giphy.com/media/8OPf6xrtXi3QEcu5h9/giphy.gif";
        questionMain.innerHTML = "JUST ANSWER IT! DO YOU LOVE CHANDRAKANT?!";
    }
